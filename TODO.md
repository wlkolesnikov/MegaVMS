...
- [x] Вкладка `Онлайн`: раздел `Виды` в боковом меню
- [x] Переключение layout/grid presets из раздела `Виды`
- [x] Создание пользовательских видов с закреплением выбранных каналов по ячейкам
- [x] Сохранение/загрузка набора видов в runtime config
- [x] Вкладка `Онлайн`: раздел управления воспроизведением/просмотром
